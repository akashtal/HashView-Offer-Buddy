                                ...
                                {categories.map((category) => {
                                    ...
                                    return (
                                        <div
                                            ...
                                            className="flex-shrink-0 flex flex-col items-center gap-2 cursor-pointer group/item"
                                        >
                                            <div
                            ...
                            >
                                {vendors.map((vendor) => (
                                    <Link
                                        ...
                                        className="flex-shrink-0 w-48 md:w-56 hover:scale-[1.02] transition-transform duration-300 block"
                                    >
